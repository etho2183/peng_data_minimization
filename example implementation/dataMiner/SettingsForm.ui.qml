...
Page {
    ...
    property alias lebel_title: lebel_title
    ...
    Column {
        ...
        Switch {
            id: switch_rng_accel
            width: 300;
            text: qsTr("obfuscate each acceleration value")
            anchors.horizontalCenter: parent.horizontalCenter
        }
        ...
        Switch {
            ...
            width: 300;
            text: qsTr("obfuscate each brightness value")
            anchors.horizontalCenter: parent.horizontalCenter
        }
        ...
        Switch {
            id: switch_rng_gyro
            width: 300;
            text: qsTr("obfuscate each gyroscope value")
            anchors.horizontalCenter: parent.horizontalCenter
        }
